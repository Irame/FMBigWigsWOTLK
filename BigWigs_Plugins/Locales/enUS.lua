...
L["Health bars"] = true
L["Clickable Health Bars"] = true
L["Value"] = true
L["Whether to show or hide the value right on the bars."] = true
L["Max Value"] = true
L["Whether to show or hide the max value right on the bars."] = true
L["Percent"] = true
L["Whether to show or hide the percent right on the bars."] = true
