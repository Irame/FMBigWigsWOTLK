...
plugin.defaultDB = {
	...
	barBackground = TukuiCF and { ["*"] = { ["*"] = { 0.1, 0.1, 0.1, 1 } } } or { ["*"] = { ["*"] = { 0.5, 0.5, 0.5, 0.3 } } },
	barText = TukuiCF and { ["*"] = { ["*"] = { 1, 1, 1 } } } or { ["*"] = { ["*"] = { 1, 1, 1 } } },
	barColor = TukuiCF and { ["*"] = { ["*"] = { 0.4, 0.4, 0.4, 1 } } } or { ["*"] = { ["*"] = { 0.25, 0.33, 0.68, 1 } } },
	barEmphasized = TukuiCF and { ["*"] = { ["*"] = { 0.6, 0.6, 0.6, 1 } } } or { ["*"] = { ["*"] = { 1, 0, 0, 1 } } },
	borderColor = TukuiCF and { ["*"] = { ["*"] = { 0.6, 0.6, 0.6, 1 } } } or nil,
	borderBackground = TukuiCF and { ["*"] = { ["*"] = { 0.2, 0.2, 0.2, 1 } } } or nil,
	...
	args = {
		...
		bars = {
			...
			args = {
				...
				borderColor = TukuiCF and {
					name = L["Border Color"],
					type = "color",
					order = 15,
					width = "half",
				},
				borderBackground = TukuiCF and {
